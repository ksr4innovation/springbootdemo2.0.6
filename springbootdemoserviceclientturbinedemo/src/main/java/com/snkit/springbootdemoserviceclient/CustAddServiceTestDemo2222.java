...
@Service
public class CustAddServiceTestDemo2222 {
	 private static final Logger logger = LoggerFactory.getLogger(CustAddServiceTestDemo2222.class);
	...
	@HystrixCommand(commandKey="getCustBySpecificationRibbon222",
	...
	@HystrixCommand(commandKey="getCustNaviteQuery222",
